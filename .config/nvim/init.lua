...
require("luasnip.loaders.from_snipmate").lazy_load() -- For honza/vim-snippets

-- Force the completion menu to be transparent and use a subtle border color
cmp.setup({
	snippet = {
...
vim.api.nvim_create_autocmd("FileType", {
	pattern = { "lua", "rust", "go", "javascript", "typescript", "c", "cpp", "python" },
	callback = function()
